...
# EXPERIMENT-ONLY: identical to llama3 but generation stops at <|end_of_text|>
# (128001) instead of the <|eot_id|> (128009) the model was trained to emit.
# Simulates a possible undocumented eos/stop-token mishandling -> runaway gen.
_register_template(
    name="llama3_eosbug",
    format_user=StringFormatter(
        slots=[
